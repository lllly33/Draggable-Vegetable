 ...
 * @LastEditTime: 2023-06-13 15:48:22
 */
import Vue from "vue";
...
const Sensor = () => import("./views/Home/Sensor.vue");
const AllotSensor = () => import("./views/Home/AllotSensor.vue");
